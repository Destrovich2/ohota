...
<?if($arResult["SECTIONS"]){?>
    ...
    <? //echo '</pre>'; ?>
        ...
        $arSelect = Array("ID", "IBLOCK_ID","NAME","ACTIVE","DETAIL_PICTURE","DETAIL_PAGE_URL","PROPERTY_*");
