...
.card__main-consult:before {
    content: "";
    width: 24px;
    height: 24px;
    background-image: url(https://www.ohotnik-shop.ru/images/card__main-consult.svg);
					...
					<div class="prices_block">
						<?ob_start()?>
							...
							<?else:?>
								...
								<p class="card__main-subtitle">Артикулы: <?=$arResult['PROPERTIES']['CML2_ARTICLE']['VALUE']?></p>		
