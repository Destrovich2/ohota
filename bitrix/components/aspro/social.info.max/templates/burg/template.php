...
<?$this->setFrameMode(true);?>
	...
	<!-- noindex -->
			...
			<?if(!empty($arResult['SOCIAL_INSTAGRAM'])):?>
 			<a href="<?=$arResult['SOCIAL_INSTAGRAM']?>" class="hamburger__social-item"><img style="display: block;width: 40px;margin-right: 30px;" src="/images/insta.svg"></a>
                ...
                <a href="<?=$whatsHref?>" class="footer__social-item">
                  <svg width="50" height="50" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 40px;">
